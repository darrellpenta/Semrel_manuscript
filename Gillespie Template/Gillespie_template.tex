...
\markright{{\hfill Prosody reflects semantic integration\hspace{2em}}} %% page head
...
linguistic planning; semantic integration; prosody; ToBI; word duration
\end{abstract}
