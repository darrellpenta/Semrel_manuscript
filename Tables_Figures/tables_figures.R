...
cat(line, br)
cat("COLLAPSING OVER LOCAL NOUN", br)
print(d0.s)
...
cat(line,br)
cat("RELATEDNESS PARAGRAPH (ROUGH DRAFT)", br)
...
cat("PROP: Integration NORMING PARA")
...
write.xlsx( regressions.ds, file = "output/table23_SR1 & 2_regression_model_comparisons.xlsx", col.names = TRUE, row.names = FALSE, append = FALSE)
# ----------------------------- MODELS GROUPED BY EXPERIMENT
regressions2.ds <-data.frame( 
  ...
  FIXED.PRED1.F1   = c( 
    ...
    paste(round( s.m1.f1[[10]][[9]], digits = 3),      get_stars( p.s.m1.f1.r),  sep = ""),
    paste(round( s.m1a.f1[[10]][[9]], digits = 3),     get_stars( p.s.m1a.f1.r), sep = ""),
    paste(round( s.m1b.f1[[10]][[9]], digits = 3),     get_stars( p.s.m1b.f1.r), sep = ""),
    paste(round( s.m2.f1[[10]][[10]], digits = 3),     get_stars( p.s.m2.f1.r),  sep = ""),
    paste(round( s.m3.f1[[10]][[9]], digits = 3),      get_stars( p.s.m3.f1.r),  sep = ""),
    paste(round( s.m3a.f1[[10]][[9]], digits = 3),     get_stars( p.s.m3a.f1.r), sep = ""),
    paste(round( s.m3b.f1[[10]][[9]], digits = 3),     get_stars( p.s.m3b.f1.r), sep = ""),
    paste( "", sep = ""),
    paste( "F1 REL/ASSOC", sep = ""),
    paste(round( s.m10.f1[[10]][[9]], digits = 3),     get_stars( p.s.m10.f1.r),  sep = ""),
    paste(round( s.m10a.f1[[10]][[9]], digits = 3),    get_stars( p.s.m10a.f1.r), sep = ""),
    paste(round( s.m10b.f1[[10]][[9]], digits = 3),    get_stars( p.s.m10b.f1.r), sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "F1 REL/ASSOC", sep = ""),
    paste(round( s.m100.f1[[10]][[9]], digits = 3),    get_stars( p.s.m100.f1.r), sep = ""),
    paste(round( s.m100a.f1[[10]][[9]], digits = 3),   get_stars( p.s.m100a.f1.r), sep = ""),
    paste(round( s.m100b.f1[[10]][[9]], digits = 3),   get_stars( p.s.m100b.f1.r), sep = ""),
    paste(round( s.m200.f1[[10]][[10]], digits = 3),   get_stars( p.s.m200.f1.r), sep = ""),
    paste(round( s.m300.f1[[10]][[9]], digits = 3),    get_stars( p.s.m300.f1.r), sep = ""),
    paste(round( s.m300a.f1[[10]][[9]], digits = 3),   get_stars( p.s.m300a.f1.r), sep = ""),
    paste(round( s.m300b.f1[[10]][[9]], digits = 3),   get_stars( p.s.m300b.f1.r), sep = ""),
    paste( "", sep = ""),
    paste( "F1 REL/ASSOC", sep = ""),
    paste(round( s.m1000.f1[[10]][[9]], digits = 3),   get_stars( p.s.m1000.f1.r),sep = ""),
    paste(round( s.m1000a.f1[[10]][[9]], digits = 3),  get_stars( p.s.m1000a.f1.r),sep = ""),
    paste(round( s.m1000b.f1[[10]][[9]], digits = 3),  get_stars( p.s.m1000b.f1.r),sep = ""),
    paste(round( s.m2000.f1[[10]][[10]], digits = 3),  get_stars( p.s.m2000.f1.r),sep = ""),
    paste(round( s.m3000.f1[[10]][[9]], digits = 3),   get_stars( p.s.m3000.f1.r),sep = ""),
    paste(round( s.m3000a.f1[[10]][[9]], digits = 3),  get_stars( p.s.m3000a.f1.r),sep = ""),
    paste(round( s.m3000b.f1[[10]][[9]], digits = 3),  get_stars( p.s.m3000b.f1.r), sep = "")
  ),
  
 
   FIXED.PRED2.F1   = c( 
    paste( "F1 INT", sep = ""),
    paste(round( s.m1.f1[[10]][[10]], digits = 3),     get_stars( p.s.m1.f1.i),  sep = ""),
    paste(round( s.m1a.f1[[10]][[10]], digits = 3),    get_stars( p.s.m1a.f1.i), sep = ""), 
    paste(round( s.m1b.f1[[10]][[10]], digits = 3),    get_stars( p.s.m1b.f1.i), sep = ""), 
    paste(round( s.m2.f1[[10]][[9]], digits = 3),      get_stars( p.s.m2.f1.i),  sep = ""), 
    paste(round( s.m3.f1[[10]][[10]], digits = 3),     get_stars( p.s.m3.f1.i),  sep = ""),
    paste(round( s.m3a.f1[[10]][[10]], digits = 3),    get_stars( p.s.m3a.f1.i), sep = ""), 
    paste(round( s.m3b.f1[[10]][[10]], digits = 3),    get_stars( p.s.m3b.f1.i), sep = ""),  
    paste( "", sep = ""),
    paste( "F1 INT", sep = ""),
    paste(round( s.m10.f1[[10]][[10]], digits = 3),    get_stars( p.s.m10.f1.i),  sep = ""),  
    paste(round( s.m10a.f1[[10]][[10]], digits = 3),   get_stars( p.s.m10a.f1.i), sep = ""),  
    paste(round( s.m10b.f1[[10]][[10]], digits = 3),   get_stars( p.s.m10b.f1.i), sep = ""), 
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "F1 INT", sep = ""),
    paste(round( s.m100.f1[[10]][[10]], digits = 3),   get_stars( p.s.m100.f1.i),  sep = ""), 
    paste(round( s.m100a.f1[[10]][[10]], digits = 3),  get_stars( p.s.m100a.f1.i), sep = ""), 
    paste(round( s.m100b.f1[[10]][[10]], digits = 3),  get_stars( p.s.m100b.f1.i), sep = ""), 
    paste(round( s.m200.f1[[10]][[9]], digits = 3),    get_stars( p.s.m200.f1.i),  sep = ""), 
    paste(round( s.m300.f1[[10]][[10]], digits = 3),   get_stars( p.s.m300.f1.i),  sep = ""),
    paste(round( s.m300a.f1[[10]][[10]], digits = 3),  get_stars( p.s.m300a.f1.i), sep = ""), 
    paste(round( s.m300b.f1[[10]][[10]], digits = 3),  get_stars( p.s.m300b.f1.i), sep = ""), 
    paste( "", sep = ""),
    paste( "F1 INT", sep = ""),
    paste(round( s.m1000.f1[[10]][[10]], digits = 3),  get_stars( p.s.m1000.f1.i),  sep = ""),  
    paste(round( s.m1000a.f1[[10]][[10]], digits = 3), get_stars( p.s.m1000a.f1.i), sep = ""),  
    paste(round( s.m1000b.f1[[10]][[10]], digits = 3), get_stars( p.s.m1000b.f1.i), sep = ""),  
    paste(round( s.m2000.f1[[10]][[9]], digits = 3),   get_stars( p.s.m2000.f1.i),  sep = ""), 
    paste(round( s.m3000.f1[[10]][[10]], digits = 3),  get_stars( p.s.m3000.f1.i),  sep = ""),  
    paste(round( s.m3000a.f1[[10]][[10]], digits = 3), get_stars( p.s.m3000a.f1.i), sep = ""), 
    paste(round( s.m3000b.f1[[10]][[10]], digits = 3), get_stars( p.s.m3000b.f1.i), sep ="")  
  ),
  
  
  FIXED.PRED1and2.F1   = c( 
    paste( "F1 REL/ASSOC X INT", sep = ""),
    paste(round( s.m1.f1[[10]][[11]], digits = 3),   get_stars( p.s.m1.f1.ri),  sep = ""),  
    paste(round( s.m1a.f1[[10]][[11]], digits = 3),  get_stars( p.s.m1a.f1.ri), sep = ""),    
    paste(round( s.m1b.f1[[10]][[11]], digits = 3),  get_stars( p.s.m1b.f1.ri), sep = ""),    
    paste(round( s.m2.f1[[10]][[11]], digits = 3),   get_stars( p.s.m2.f1.ri),  sep = ""),   
    paste(round( s.m3.f1[[10]][[11]], digits = 3),   get_stars( p.s.m3.f1.ri),  sep = ""),   
    paste(round( s.m3a.f1[[10]][[11]], digits = 3),  get_stars( p.s.m3a.f1.ri), sep = ""),    
    paste(round( s.m3b.f1[[10]][[11]], digits = 3),  get_stars( p.s.m3b.f1.ri), sep = ""),    
    paste( "", sep = ""),
    paste( "F1 REL/ASSOC X INT", sep = ""),
    paste(round( s.m10.f1[[10]][[11]], digits = 3), get_stars( p.s.m10.f1.ri),  sep = ""),        
    paste(round( s.m10a.f1[[10]][[11]], digits = 3), get_stars( p.s.m10a.f1.ri), sep = ""),      
    paste(round( s.m10b.f1[[10]][[11]], digits = 3), get_stars( p.s.m10b.f1.ri), sep = ""),      
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "F1 REL/ASSOC X INT", sep = ""),
    paste(round( s.m100.f1[[10]][[11]], digits = 3),    get_stars( p.s.m100.f1.ri),  sep = ""), 
    paste(round( s.m100a.f1[[10]][[11]], digits = 3),   get_stars( p.s.m100a.f1.ri), sep = ""),  
    paste(round( s.m100b.f1[[10]][[11]], digits = 3),   get_stars( p.s.m100b.f1.ri), sep = ""), 
    paste(round( s.m200.f1[[10]][[11]], digits = 3),    get_stars( p.s.m200.f1.ri),  sep = ""), 
    paste(round( s.m300.f1[[10]][[11]], digits = 3),    get_stars( p.s.m300.f1.ri),  sep = ""), 
    paste(round( s.m300a.f1[[10]][[11]], digits = 3),   get_stars( p.s.m300a.f1.ri), sep = ""), 
    paste(round( s.m300b.f1[[10]][[11]], digits = 3),   get_stars( p.s.m300b.f1.ri), sep = ""),  
    paste( "", sep = ""),
    paste( "F1 REL/ASSOC X INT", sep = ""),
    paste(round( s.m1000.f1[[10]][[11]], digits = 3),     get_stars( p.s.m1000.f1.ri),  sep = ""),  
    paste(round( s.m1000a.f1[[10]][[11]], digits = 3),    get_stars( p.s.m1000a.f1.ri), sep = ""), 
    paste(round( s.m1000b.f1[[10]][[11]], digits = 3),    get_stars( p.s.m1000b.f1.ri), sep = ""), 
    paste(round( s.m2000.f1[[10]][[11]], digits = 3),     get_stars( p.s.m2000.f1.ri),  sep = ""),  
    paste(round( s.m3000.f1[[10]][[11]], digits = 3),     get_stars( p.s.m3000.f1.ri),  sep = ""), 
    paste(round( s.m3000a.f1[[10]][[11]], digits = 3),    get_stars( p.s.m3000a.f1.ri), sep = ""), 
    paste(round( s.m3000b.f1[[10]][[11]], digits = 3),    get_stars( p.s.m3000b.f1.ri), sep = "") 
  ),
  FIXED.PRED1.F2   = c( 
    paste( "F2 REL/ASSOC", sep = ""),
    paste(round( s.m1.f2[[10]][[9]], digits = 3),      get_stars( p.s.m1.f2.r),  sep = ""),
    paste(round( s.m1a.f2[[10]][[9]], digits = 3),     get_stars( p.s.m1a.f2.r), sep = ""),
    paste(round( s.m1b.f2[[10]][[9]], digits = 3),     get_stars( p.s.m1b.f2.r), sep = ""),
    paste(round( s.m2.f2[[10]][[10]], digits = 3),     get_stars( p.s.m2.f2.r),  sep = ""),
    paste(round( s.m3.f2[[10]][[9]], digits = 3),      get_stars( p.s.m3.f2.r),  sep = ""),
    paste(round( s.m3a.f2[[10]][[9]], digits = 3),     get_stars( p.s.m3a.f2.r), sep = ""),
    paste(round( s.m3b.f2[[10]][[9]], digits = 3),     get_stars( p.s.m3b.f2.r), sep = ""),
    paste( "", sep = ""),
    paste( "F2 REL/ASSOC", sep = ""),
    paste(round( s.m10.f2[[10]][[9]], digits = 3),     get_stars( p.s.m10.f2.r),  sep = ""),
    paste(round( s.m10a.f2[[10]][[9]], digits = 3),    get_stars( p.s.m10a.f2.r), sep = ""),
    paste(round( s.m10b.f2[[10]][[9]], digits = 3),    get_stars( p.s.m10b.f2.r), sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "F2 REL/ASSOC", sep = ""),
    paste(round( s.m100.f2[[10]][[9]], digits = 3),    get_stars( p.s.m100.f2.r), sep = ""),
    paste(round( s.m100a.f2[[10]][[9]], digits = 3),   get_stars( p.s.m100a.f2.r), sep = ""),
    paste(round( s.m100b.f2[[10]][[9]], digits = 3),   get_stars( p.s.m100b.f2.r), sep = ""),
    paste(round( s.m200.f2[[10]][[10]], digits = 3),   get_stars( p.s.m200.f2.r), sep = ""),
    paste(round( s.m300.f2[[10]][[9]], digits = 3),    get_stars( p.s.m300.f2.r), sep = ""),
    paste(round( s.m300a.f2[[10]][[9]], digits = 3),   get_stars( p.s.m300a.f2.r), sep = ""),
    paste(round( s.m300b.f2[[10]][[9]], digits = 3),   get_stars( p.s.m300b.f2.r), sep = ""),
    paste( "", sep = ""),
    paste( "F2 REL/ASSOC", sep = ""),
    paste(round( s.m1000.f2[[10]][[9]], digits = 3),   get_stars( p.s.m1000.f2.r),sep = ""),
    paste(round( s.m1000a.f2[[10]][[9]], digits = 3),  get_stars( p.s.m1000a.f2.r),sep = ""),
    paste(round( s.m1000b.f2[[10]][[9]], digits = 3),  get_stars( p.s.m1000b.f2.r),sep = ""),
    paste(round( s.m2000.f2[[10]][[10]], digits = 3),  get_stars( p.s.m2000.f2.r),sep = ""),
    paste(round( s.m3000.f2[[10]][[9]], digits = 3),   get_stars( p.s.m3000.f2.r),sep = ""),
    paste(round( s.m3000a.f2[[10]][[9]], digits = 3),  get_stars( p.s.m3000a.f2.r),sep = ""),
    paste(round( s.m3000b.f2[[10]][[9]], digits = 3),  get_stars( p.s.m3000b.f2.r), sep = "")
  ),
  
  
  FIXED.PRED2.F2   = c( 
    paste( "F2 INT", sep = ""),
    paste(round( s.m1.f2[[10]][[10]], digits = 3),     get_stars( p.s.m1.f2.i),  sep = ""),
    paste(round( s.m1a.f2[[10]][[10]], digits = 3),    get_stars( p.s.m1a.f2.i), sep = ""), 
    paste(round( s.m1b.f2[[10]][[10]], digits = 3),    get_stars( p.s.m1b.f2.i), sep = ""), 
    paste(round( s.m2.f2[[10]][[9]], digits = 3),      get_stars( p.s.m2.f2.i),  sep = ""), 
    paste(round( s.m3.f2[[10]][[10]], digits = 3),     get_stars( p.s.m3.f2.i),  sep = ""),
    paste(round( s.m3a.f2[[10]][[10]], digits = 3),    get_stars( p.s.m3a.f2.i), sep = ""), 
    paste(round( s.m3b.f2[[10]][[10]], digits = 3),    get_stars( p.s.m3b.f2.i), sep = ""),  
    paste( "", sep = ""),
    paste( "F2 INT", sep = ""),
    paste(round( s.m10.f2[[10]][[10]], digits = 3),    get_stars( p.s.m10.f2.i),  sep = ""),  
    paste(round( s.m10a.f2[[10]][[10]], digits = 3),   get_stars( p.s.m10a.f2.i), sep = ""),  
    paste(round( s.m10b.f2[[10]][[10]], digits = 3),   get_stars( p.s.m10b.f2.i), sep = ""), 
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "F2 INT", sep = ""),
    paste(round( s.m100.f2[[10]][[10]], digits = 3),   get_stars( p.s.m100.f2.i),  sep = ""), 
    paste(round( s.m100a.f2[[10]][[10]], digits = 3),  get_stars( p.s.m100a.f2.i), sep = ""), 
    paste(round( s.m100b.f2[[10]][[10]], digits = 3),  get_stars( p.s.m100b.f2.i), sep = ""), 
    paste(round( s.m200.f2[[10]][[9]], digits = 3),    get_stars( p.s.m200.f2.i),  sep = ""), 
    paste(round( s.m300.f2[[10]][[10]], digits = 3),   get_stars( p.s.m300.f2.i),  sep = ""),
    paste(round( s.m300a.f2[[10]][[10]], digits = 3),  get_stars( p.s.m300a.f2.i), sep = ""), 
    paste(round( s.m300b.f2[[10]][[10]], digits = 3),  get_stars( p.s.m300b.f2.i), sep = ""), 
    paste( "", sep = ""),
    paste( "F2 INT", sep = ""),
    paste(round( s.m1000.f2[[10]][[10]], digits = 3),  get_stars( p.s.m1000.f2.i),  sep = ""),  
    paste(round( s.m1000a.f2[[10]][[10]], digits = 3), get_stars( p.s.m1000a.f2.i), sep = ""),  
    paste(round( s.m1000b.f2[[10]][[10]], digits = 3), get_stars( p.s.m1000b.f2.i), sep = ""),  
    paste(round( s.m2000.f2[[10]][[9]], digits = 3),   get_stars( p.s.m2000.f2.i),  sep = ""), 
    paste(round( s.m3000.f2[[10]][[10]], digits = 3),  get_stars( p.s.m3000.f2.i),  sep = ""),  
    paste(round( s.m3000a.f2[[10]][[10]], digits = 3), get_stars( p.s.m3000a.f2.i), sep = ""), 
    paste(round( s.m3000b.f2[[10]][[10]], digits = 3), get_stars( p.s.m3000b.f2.i), sep ="")  
  ),
  
  
  FIXED.PRED1and2.F2   = c( 
    paste( "F2 REL/ASSOC X INT", sep = ""),
    paste(round( s.m1.f2[[10]][[11]], digits = 3),   get_stars( p.s.m1.f2.ri),  sep = ""),  
    paste(round( s.m1a.f2[[10]][[11]], digits = 3),  get_stars( p.s.m1a.f2.ri), sep = ""),    
    paste(round( s.m1b.f2[[10]][[11]], digits = 3),  get_stars( p.s.m1b.f2.ri), sep = ""),    
    paste(round( s.m2.f2[[10]][[11]], digits = 3),   get_stars( p.s.m2.f2.ri),  sep = ""),   
    paste(round( s.m3.f2[[10]][[11]], digits = 3),   get_stars( p.s.m3.f2.ri),  sep = ""),   
    paste(round( s.m3a.f2[[10]][[11]], digits = 3),  get_stars( p.s.m3a.f2.ri), sep = ""),    
    paste(round( s.m3b.f2[[10]][[11]], digits = 3),  get_stars( p.s.m3b.f2.ri), sep = ""),    
    paste( "", sep = ""),
    paste( "F2 REL/ASSOC X INT", sep = ""),
    paste(round( s.m10.f2[[10]][[11]], digits = 3), get_stars( p.s.m10.f2.ri),  sep = ""),        
    paste(round( s.m10a.f2[[10]][[11]], digits = 3), get_stars( p.s.m10a.f2.ri), sep = ""),      
    paste(round( s.m10b.f2[[10]][[11]], digits = 3), get_stars( p.s.m10b.f2.ri), sep = ""),      
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "", sep = ""),
    paste( "F2 REL/ASSOC X INT", sep = ""),
    paste(round( s.m100.f2[[10]][[11]], digits = 3),    get_stars( p.s.m100.f2.ri),  sep = ""), 
    paste(round( s.m100a.f2[[10]][[11]], digits = 3),   get_stars( p.s.m100a.f2.ri), sep = ""),  
    paste(round( s.m100b.f2[[10]][[11]], digits = 3),   get_stars( p.s.m100b.f2.ri), sep = ""), 
    paste(round( s.m200.f2[[10]][[11]], digits = 3),    get_stars( p.s.m200.f2.ri),  sep = ""), 
    paste(round( s.m300.f2[[10]][[11]], digits = 3),    get_stars( p.s.m300.f2.ri),  sep = ""), 
    paste(round( s.m300a.f2[[10]][[11]], digits = 3),   get_stars( p.s.m300a.f2.ri), sep = ""), 
    paste(round( s.m300b.f2[[10]][[11]], digits = 3),   get_stars( p.s.m300b.f2.ri), sep = ""),  
    paste( "", sep = ""),
    paste( "F2 REL/ASSOC X INT", sep = ""),
    paste(round( s.m1000.f2[[10]][[11]], digits = 3),     get_stars( p.s.m1000.f2.ri),  sep = ""),  
    paste(round( s.m1000a.f2[[10]][[11]], digits = 3),    get_stars( p.s.m1000a.f2.ri), sep = ""), 
    paste(round( s.m1000b.f2[[10]][[11]], digits = 3),    get_stars( p.s.m1000b.f2.ri), sep = ""), 
    paste(round( s.m2000.f2[[10]][[11]], digits = 3),     get_stars( p.s.m2000.f2.ri),  sep = ""),  
    paste(round( s.m3000.f2[[10]][[11]], digits = 3),     get_stars( p.s.m3000.f2.ri),  sep = ""), 
    paste(round( s.m3000a.f2[[10]][[11]], digits = 3),    get_stars( p.s.m3000a.f2.ri), sep = ""), 
    paste(round( s.m3000b.f2[[10]][[11]], digits = 3),    get_stars( p.s.m3000b.f2.ri), sep = "") 
...
g7  <- ggplot(data = beta.table.7, aes(x = GROUPING.FACTOR, y = Beta, fill = Predictor)) +
  geom_bar(width=.65, stat="identity", position = position_dodge(width = 0.7)) +
  scale_fill_manual(values=c("#990000", "#FFdb99", "#525252" )) +
  scale_x_discrete(limits = positions) +
  geom_hline(yintercept = 0) +
# Change aesthetics of bar graph
  theme_classic() +
