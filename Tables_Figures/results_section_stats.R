...
main_effect1 <-cat("Participants produced more agreement errors in the plural local noun conditions than in the singular local noun conditions. Aditionally, more agreement errors were made for realted preambles versus unrelated preambles. Crucially, there was a two-way interaction bewteen local noun number and relatedness, and the head-local mismatch effect was larger for related cases (r\\textit{F$_1$}(",dfr1,",",dfr2,")=",f,", r\\textit{MS$_e$}=",m,",r\\textit{p}",get_range( p),"; ", sep="" ) 
# ================== RELATED MISMATCH F2 ==========
