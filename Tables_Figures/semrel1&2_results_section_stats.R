...
cat(line,br,line,br)
summary <- cat("Accross all ",length( d.sr$maincode)," trials, there were ", sum( d.sr$corrd), " correctly inflected respones, ", sum( d.sr$errd), " agreement errors, ", sum( d.sr$unind), " uninflected responses, ", sum( d.sr$misc), " miscellaneous cases, and ",sum( d.sr$noresp), " trials with no response.", sep="")
print(summary)
cat( br, br, line, br)
...
main_effect1 <-cat("Participants produced more agreement errors in the plural local noun conditions than in the singular local noun conditions. Aditionally, more agreement errors were made for realted preambles versus unrelated preambles. Crucially, there was a two-way interaction bewteen local noun number and relatedness, and the head-local mismatch effect was larger for related cases (F1(",dfr1,",",dfr2,")=",f,", MSe=",m,",p",get_range( p),"; ", sep="" ) 
# ================== RELATED MISMATCH F2 ==========
...
main_effect1 <-paste("Associates also generated more agreement errors than unrelated items (F1(",dfr1,",",dfr2,")=",f,", MSe=",m,",p",get_range( p),"; ", sep="" )     
...
main_effect3 <-paste(main_effect2, "and there was a local noun number by associate interaction (F1(",dfr1,",",dfr2,")=",f,", MSe=",m,",p",get_range( p),"; ", sep="" )     
...
main_effect4 <-paste(main_effect3,"F2(", dfr1,",",dfr2,")=",f,", MSe=",m,",p", get_range( p),"), the mismatch effect being larger for associates than for unrelated items (F1(", sep="" )
...
main_effect6 <-paste(main_effect5,"F2(", dfr1,",",dfr2,")=",f,", MSe=",m,",p", get_range( p),").", sep="" )
cat(main_effect6, br)
...
main_effect1 <-paste("===== 1. ARCSIN TRANSFORMED PROPORTIONS: UNRELATED (F1(",dfr1,",",dfr2,")=",f,", MSe=",m,",p",get_range( p),"; ", sep="" )     
...
main_effect1 <-paste("===== 2. ERRORS NO DYSFLUENCIES: UNRELATED (F1(",dfr1,",",dfr2,")=",f,", MSe=",m,",p",get_range( p),"; ", sep="" )   
# ------------------ ERR NO DYS UNRELATED MISMATCH F2 -----------
source(file = "semrel2_PROP_f2_ANOVAS_read_in_dataframe.R")
...
main_effect1 <-paste("===== 3. ERRORS COUNTS: UNRELATED (F1(",dfr1,",",dfr2,")=",f,", MSe=",m,",p",get_range( p),"; ", sep="" )  
# ------------------ ERR COUNTS ASSOCIATE MISMATCH F2 -----------
source(file = "semrel2_PROP_f2_ANOVAS_read_in_dataframe.R")
d0   <- aov(count ~ n2num + Error(item / n2num), data = cnt.unrel)
...
main_effect1 <-paste("A comparison of attribute and unrelated items revealed a marginal main effect of relationship as related items generated more errors than unrelated items (F1(",dfr1,",",dfr2,")=",f,", MSe=",m,",p",get_range( p),"; ", sep="" )     
...
main_effect3 <-paste(main_effect2, "There was also an interaction that was significant by items and marginally significant by subjects (F1(",dfr1,",",dfr2,")=",f,", MSe=",m,",p",get_range( p),"; ", sep="" )     
...
main_effect4 <-paste(main_effect3,"F2(", dfr1,",",dfr2,")=",f,", MSe=",m,",p", get_range( p),"), the mismatch effect being larger for attributes than for unrelated items.", sep="")
