...
f.1       <- as.character(lme4:::findbars(m1.f1@call))
f.10      <- as.character(lme4:::findbars(m10.f1@call))
f.100     <- as.character(lme4:::findbars(m100.f1@call))
f.10000   <- as.character(lme4:::findbars(m10000.f1@call))
f.1000    <- as.character(lme4:::findbars(m1000.f1@call))
f.1a       <- as.character(lme4:::findbars(m1a.f1@call))
f.10a      <- as.character(lme4:::findbars(m10a.f1@call))
f.100a     <- as.character(lme4:::findbars(m100a.f1@call))
f.10000a   <- as.character(lme4:::findbars(m10000a.f1@call))
f.1000a     <- as.character(lme4:::findbars(m1000a.f1@call))
f.1b       <- as.character(lme4:::findbars(m1b.f1@call))
f.10b      <- as.character(lme4:::findbars(m10b.f1@call))
f.100b      <- as.character(lme4:::findbars(m100b.f1@call))
f.10000b   <- as.character(lme4:::findbars(m10000b.f1@call))
f.1000b    <- as.character(lme4:::findbars(m1000b.f1@call))
f.2         <- as.character(lme4:::findbars(m2.f1@call))
f.20        <- as.character(lme4:::findbars(m20.f1@call))
f.200      <- as.character(lme4:::findbars(m200.f1@call))
f.20000   <- as.character(lme4:::findbars(m20000.f1@call))
f.2000     <- as.character(lme4:::findbars(m2000.f1@call))
f.3           <- as.character(lme4:::findbars(m3.f1@call))
f.30         <- as.character(lme4:::findbars(m30.f1@call))
f.300       <- as.character(lme4:::findbars(m300.f1@call))
f.30000   <- as.character(lme4:::findbars(m30000.f1@call))
f.3000     <- as.character(lme4:::findbars(m3000.f1@call))
f.3a           <- as.character(lme4:::findbars(m3a.f1@call))
f.30a         <- as.character(lme4:::findbars(m30a.f1@call))
f.300a       <- as.character(lme4:::findbars(m300a.f1@call))
f.30000a   <- as.character(lme4:::findbars(m30000a.f1@call))
f.3000a     <- as.character(lme4:::findbars(m3000a.f1@call))
f.3b           <- as.character(lme4:::findbars(m3b.f1@call))
f.30b         <- as.character(lme4:::findbars(m30b.f1@call))
f.300b       <- as.character(lme4:::findbars(m300b.f1@call))
f.30000b   <- as.character(lme4:::findbars(m30000b.f1@call))
f.3000b     <- as.character(lme4:::findbars(m3000b.f1@call))

ff.1       <- as.character(lme4:::findbars(m1.f2@call))
ff.10      <- as.character(lme4:::findbars(m10.f2@call))
ff.100     <- as.character(lme4:::findbars(m100.f2@call))
ff.10000   <- as.character(lme4:::findbars(m10000.f2@call))
ff.1000    <- as.character(lme4:::findbars(m1000.f2@call))
ff.1a       <- as.character(lme4:::findbars(m1a.f2@call))
ff.10a      <- as.character(lme4:::findbars(m10a.f2@call))
ff.100a     <- as.character(lme4:::findbars(m100a.f2@call))
ff.10000a   <- as.character(lme4:::findbars(m10000a.f2@call))
ff.1000a     <- as.character(lme4:::findbars(m1000a.f2@call))
ff.1b       <- as.character(lme4:::findbars(m1b.f2@call))
ff.10b      <- as.character(lme4:::findbars(m10b.f2@call))
ff.100b      <- as.character(lme4:::findbars(m100b.f2@call))
ff.10000b   <- as.character(lme4:::findbars(m10000b.f2@call))
ff.1000b    <- as.character(lme4:::findbars(m1000b.f2@call))
ff.2         <- as.character(lme4:::findbars(m2.f2@call))
ff.20        <- as.character(lme4:::findbars(m20.f2@call))
ff.200      <- as.character(lme4:::findbars(m200.f2@call))
ff.20000   <- as.character(lme4:::findbars(m20000.f2@call))
ff.2000     <- as.character(lme4:::findbars(m2000.f2@call))
ff.3           <- as.character(lme4:::findbars(m3.f2@call))
ff.30         <- as.character(lme4:::findbars(m30.f2@call))
ff.300       <- as.character(lme4:::findbars(m300.f2@call))
ff.30000   <- as.character(lme4:::findbars(m30000.f2@call))
ff.3000     <- as.character(lme4:::findbars(m3000.f2@call))
ff.3a           <- as.character(lme4:::findbars(m3a.f2@call))
ff.30a         <- as.character(lme4:::findbars(m30a.f2@call))
ff.300a       <- as.character(lme4:::findbars(m300a.f2@call))
ff.30000a   <- as.character(lme4:::findbars(m30000a.f2@call))
ff.3000a     <- as.character(lme4:::findbars(m3000a.f2@call))
ff.3b           <- as.character(lme4:::findbars(m3b.f2@call))
ff.30b         <- as.character(lme4:::findbars(m30b.f2@call))
ff.300b       <- as.character(lme4:::findbars(m300b.f2@call))
ff.30000b   <- as.character(lme4:::findbars(m30000b.f2@call))
ff.3000b     <- as.character(lme4:::findbars(m3000b.f2@call))
