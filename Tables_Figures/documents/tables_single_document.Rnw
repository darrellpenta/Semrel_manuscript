...
xtable(exp1.example, caption = c(" Experiment 1 critical item example","Exp.1 Critical item"), align = "lllll")
@
...
xtable(exp1.related, caption = c(" Experiment 1 mean relatedness ratings","Exp.1 Relatedness"), align = "lllll")
...
xtable(exp1.integration, caption = c("Experiment 1 mean integration ratings", "Exp 1. Integration"))
...
xtable(exp1.assoc, caption=c("Experiment 1 head-to-local association proportions", "Exp. 1 Association"))
@
...
xtable(exp1.err.rates , caption = c("Experiment 1 Error Rate and Response Counts", "Exp1. Errors and Responses"))
@
\end{landscape}
...
xtable(error.rate.ANOVA, caption = c("Experiment 1 Error Rate ANOVAs", "Exp.1 Error ANOVAs"))
@
...
xtable( exp2.cat.example, caption = c("Category critical item versions", "Category Item"))
@
...
xtable( exp2.prop.example, caption = c("Property critical item versions", "Property Item"))
@
...
xtable(exp2.related, caption = c("Category Coordinates Mean relatedness ratings.xlsx", "CAT COORD Relatedness"))
...
# ----------------------------- INTEGRATION DATAFRAME: Write to excel -----------  
xtable(exp2.integration, caption =c("Category Coordinate mean integration rating", "CAT COORD Integration"))
@
\begin{landscape}
...
xtable(exp2.related, caption =c("Property mean relatedness ratings", "PROP Relatedness"))
@
...
xtable(exp2.integration, caption =c("Property mean integration ratings", "PROP Integration"))
...
xtable(exp2.association, caption =c("Property head-to-local association proportions", "PROP association"))
...
xtable(exp2.err.rates, caption=c("Experiment 2 Error rates and response counts", "Exp. 2 Error rates"))
@
\end{landscape}
