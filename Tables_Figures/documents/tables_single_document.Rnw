\documentclass[a4paper,11pt]{article} % THIS IS TEST
...
<<global, echo=FALSE>>=
opts_chunk$set(echo=FALSE, message = FALSE, warning = FALSE, error = FALSE, eval = TRUE, cache=TRUE)
library(knitr)
library(xtable)
@
...
xtable(exp1.example, caption = c(" Experiment 1 critical item example","Exp.1 Critical item"), caption.placement = 'top', align = "lllll")
@

<<table 2, results='asis'>>=
# -------------------- TABLE 02 SEMREL: RELATEDNESS -----------------------------
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
...
xtable(exp1.related, caption = c(" Experiment 1 mean relatedness ratings","Exp.1 Relatedness"), caption.placement = 'top', align = "lllll")

@

<<table 3, results='asis'>>=
...
xtable(exp1.integration, caption = c("Experiment 1 mean integration ratings", "Exp 1. Integration"), caption.placement = 'top')


@

<<table 4, results='asis'>>=
...
xtable(exp1.assoc, caption=c("Experiment 1 head-to-local association proportions", "Exp. 1 Association"), caption.placement = 'top')
@

<<table 5, results='asis'>>=
...
xtable(exp1.err.rates , caption = c("Experiment 1 Error Rate and Response Counts", "Exp1. Errors and Responses"), caption.placement = 'top')
@
\end{landscape}
<<table 6, results='asis'>>=
...
xtable(error.rate.ANOVA, caption = c("Experiment 1 Error Rate ANOVAs", "Exp.1 Error ANOVAs"), caption.placement = 'top')
@

<<table 7, results='asis'>>=
...
xtable( exp2.cat.example, caption = c("Category critical item versions", "Category Item"), caption.placement = 'top')
@

<<table 8, results='asis'>>=
...
xtable( exp2.prop.example, caption = c("Property critical item versions", "Property Item"), caption.placement = 'top')
@

<<table 9, results='asis'>>=
...
xtable(exp2.related, caption = c("Category Coordinates Mean relatedness ratings", "CAT COORD Relatedness"), caption.placement = 'top')

@

<<table 10, results='asis'>>=
...
# ----------------------------- INTEGRATION DATAFRAME: Write to excel -----------  
xtable(exp2.integration, caption =c("Category Coordinate mean integration rating", "CAT COORD Integration"), caption.placement = 'top')
@

\begin{landscape}
<<table 11, results='asis'>>=
...
xtable(exp2.related, caption =c("Property mean relatedness ratings", "PROP Relatedness"), caption.placement = 'top')
@

<<table 12, results='asis'>>=
...
xtable(exp2.integration, caption =c("Property mean integration ratings", "PROP Integration"), caption.placement = 'top')

@

<<table 13, results='asis'>>=
...
xtable(exp2.association, caption =c("Property head-to-local association proportions", "PROP association"), caption.placement = 'top')

@

<<table 14, results='asis'>>=
...
xtable(exp2.err.rates, caption=c("Experiment 2 Error rates and response counts", "Exp. 2 Error rates"), caption.placement = 'top')
@
\end{landscape}

<<table 15, results='asis'>>=
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "clear_and_setup.R")
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
...
xtable(error.rate.ANOVA, caption=c("CAT error rate ANOVAs", "CAT Error Rate ANOVAs"), caption.placement='top')
@

<<table 16, results='asis'>>=
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "clear_and_setup.R")
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
...
xtable(error.rate.ANOVA, caption=c("PROP error rate ANOVAs", "PROP Error Rate ANOVAs"), caption.placement='top')
@

<<table 17, results='asis'>>=
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "clear_and_setup.R")
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "semrel_error_data_read_in_dataframe.R")
...
xtable(error.rate.ANOVA, caption = c("Experiment 1 Uninflected Responses","Exp. 1 Uninflected"))
@

<<table 18, results='asis'>>=
...
xtable(error.rate.ANOVA, caption = c("Experiment 1 Miscellaneous responses","Exp. 1 Miscellaneous"))
@

<<table 19, results='asis'>>=
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "clear_and_setup.R")
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "semrel2_CAT_error_data_read_in_dataframe.R")
...
xtable(error.rate.ANOVA, caption = c("CAT Uninflected ANOVAs","CAT Uninflected ANOVAs"))

@

<<table 20, results='asis'>>=
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "clear_and_setup.R")
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "clear_and_setup.R")
...
xtable(error.rate.ANOVA, caption = c("CAT Miscellaneous ANOVAs","CAT Miscellaneous ANOVAs"))
@

<<table 21, results='asis'>>=
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "clear_and_setup.R")
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "semrel2_PROP_error_data_read_in_dataframe.R")
...
xtable(error.rate.ANOVA, caption = c("PROP Uninflected ANOVAs","PROP Uninflected ANOVAs"))

@


<<table 22, results='asis'>>=
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "clear_and_setup.R")
setwd("/Users/darrellpenta/Desktop/Manuscripts/semrel_manuscript/Tables_Figures")
source( file = "semrel2_PROP_error_data_read_in_dataframe.R")
...
error.rate.ANOVA <- cbind(error.rate.ANOVA.1,error.rate.ANOVA.2[,c(2:3)])
xtable(error.rate.ANOVA, caption = c("PROP Miscellaneous ANOVAs","PROP Miscellaneous ANOVAs"))
@

\clearpage{}
<<table 23, results='asis'>>=
...
xtable(example, caption = c("Regression model comparisons", "Regression model comparisons"), caption.placement = 'top')
@
